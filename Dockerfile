...
# Create emulator
RUN echo "no" | android create avd --force --device "Nexus 5" --name Nexus_5_armeabi_v7a --target android-24 --abi armeabi_v7a --skin WVGA800 --sdcard 512M
RUN echo "no" | android create avd --force --device "Nexus 5" --name Nexus_5_arm64_v8a --target android-24 --abi arm64_v8a --skin WVGA800 --sdcard 512M
